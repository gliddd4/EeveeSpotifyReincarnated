...
EeveeSpotify_FILES = $(shell find Sources/EeveeSpotify -name '*.swift' ! -name 'Package.swift') $(shell find Sources/EeveeSpotifyC -name '*.m' -o -name '*.c' -o -name '*.mm' -o -name '*.cpp')
